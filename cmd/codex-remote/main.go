...
func usage() {
	...
	fmt.Fprintln(os.Stderr, "  codex-remote exec run   --machine <name> --cmd <string> [--script PATH] [--project <id> --ref <ref>] [--cwd <path>] [--env KEY=VAL ...]")
	fmt.Fprintln(os.Stderr, "  codex-remote exec start --machine <name> --cmd <string> [--script PATH] [--project <id> --ref <ref>] [--cwd <path>] [--env KEY=VAL ...]")
